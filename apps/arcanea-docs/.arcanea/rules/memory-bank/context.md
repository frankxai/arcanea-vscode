...
The Arcanea documentation site is a mature, production-ready Docusaurus project that serves as the comprehensive documentation hub for the Arcanea VS Code extension. The site is hosted at https://arcanea.ai/docs and provides extensive documentation covering installation, usage, features, and extension capabilities.
...
- **Using Arcanea**: Chat interface, modes, context mentions, and basic features
...
- **Extending Arcanea**: Model providers (18+ supported), local models, MCP integration, shell integration
