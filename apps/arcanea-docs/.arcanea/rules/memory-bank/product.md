...
Users interact with Arcanea through a chat interface within VS Code, using natural language to describe what they want to accomplish. Arcanea then uses specialized modes and tools to fulfill requests.
...
### Tool Ecosystem
Arcanea uses a sophisticated tool system organized into groups:
