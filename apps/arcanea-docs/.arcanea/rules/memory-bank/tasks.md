...
This file documents common repetitive tasks and workflows for maintaining the Arcanea documentation site.
...
2. Follow the standard provider documentation template:
   ...
   - Configuration in Arcanea section
...
# Using [Provider Name] With Arcanea
