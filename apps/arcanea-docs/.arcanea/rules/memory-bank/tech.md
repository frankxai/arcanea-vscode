...
### GitHub Integration
- **Repository**: https://github.com/Arcanea-Org/docs
- **Edit Links**: Direct links to GitHub for documentation editing
- **Issue Reporting**: Integrated issue creation workflow

### Community Platforms
- **Discord**: https://arcanea.ai/discord
- **Reddit**: https://www.reddit.com/r/arcanea/
- **Twitter**: https://x.com/Arcanea_Code
- **YouTube**: https://www.youtube.com/@Arcanea-Code

### VS Code Marketplace
- **Extension URL**: https://marketplace.visualstudio.com/items?itemName=arcanea.arcanea
- **Open VSX**: https://open-vsx.org/extension/arcanea/arcanea

## Deployment Architecture

### Static Site Hosting
- **Production URL**: https://arcanea.ai/docs
