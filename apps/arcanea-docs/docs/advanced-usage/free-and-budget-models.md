...
# Using Arcanea for Free and on a Budget

**Why this matters:** AI model costs can add up quickly during development. This guide shows you how to use Arcanea effectively while minimizing or eliminating costs through free models, budget-friendly alternatives, and smart usage strategies.

## Completely Free Options

### Grok Code Fast 1

This frontier AI model is 100% free in Arcanea for a limited time. [See the blog post for more details](https://blog.arcanea.ai/p/grok-code-fast-get-this-frontier-ai-model-free).
...
3. Configure Arcanea with the OpenRouter provider
...
- [Disable MCP](/features/mcp/using-mcp-in-arcanea) if not using external tools
...
2. **Configure multiple providers** in Arcanea
