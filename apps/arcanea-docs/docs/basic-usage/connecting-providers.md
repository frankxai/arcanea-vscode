...
**Bottom line**: Arcanea, like any agentic AI coding tool, needs AI model providers to function. You can use our [built-in provider](/providers/arcanea) (easiest) or connect your own API keys from **30+ providers**.

## Arcanea Extension vs. API Provider

### The Extension

- VS Code tool you install from the marketplace
- Handles UI, file operations, and workflow management
- [Open source](https://github.com/Arcanea-Org/arcanea)
- Connects to any AI provider

### Arcanea API Provider
...
- [Competitive pricing](https://arcanea.ai/pricing)
...
- Sign in with Google or GitHub at arcanea.ai
- Free credits included for your first top-up
- Zero API key management
- Latest models available

→ [Complete setup guide](/providers/arcanea)
...
3. Configure in Arcanea settings
