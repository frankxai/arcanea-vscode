...
Generate descriptive commit messages automatically based on your staged git changes. Arcanea analyzes your staged files and creates conventional commit messages that follow best practices.
...
2. In the VS Code Source Control panel, look for the `Arcanea` logo next to the commit message field)
...
- [Settings Management](/features/settings-management) - Manage all your Arcanea preferences