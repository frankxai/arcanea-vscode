...
Arcanea uses tools to interact with your code and environment. These specialized helpers perform specific actions like reading files, making edits, running commands, or searching your codebase. Tools provide automation for common development tasks without requiring manual execution.

## Tool Workflow

Describe what you want to accomplish in natural language, and Arcanea will:
...
**Arcanea:** (Proposes the `write_to_file` tool as shown in the image above)
```xml
<write_to_file>
...
**Arcanea:** (Confirms file creation)

## Tool Safety and Approval


Every tool use requires your explicit approval. When Arcanea proposes a tool, you'll see:
