...
<img src="/docs/img/task-todo-list/task-todo-list-1.png" alt="Task Todo List overview showing interactive checklist in Arcanea" width="500" />
...
**Manual triggers**:
- Ask Arcanea to "use the [update_todo_list tool](/features/tools/update-todo-list)"
- Say "create a todo list"

**The bottom line**: Arcanea decides what goes in the list, but you can provide feedback during approval dialogs.
...
**Now**: Arcanea creates structured checklists that update automatically as work progresses. You see exactly where you are and what's coming up.
...
- Edit descriptions when Arcanea asks for approval
- Stage changes using the "Edit" button

**3. Environment Details**
Background "REMINDERS" table that keeps Arcanea informed about current progress
...
Yes, just ask Arcanea to use the update_todo_list tool. But Arcanea stays in control of the content and workflow.

**"What about simple tasks?"**
Arcanea typically skips todo lists for simple tasks. The overhead isn't worth it.

**"Why can't I directly edit the list?"**
Design choice. Arcanea maintains authority over task management to ensure consistent progress tracking. You provide input, Arcanea executes.
