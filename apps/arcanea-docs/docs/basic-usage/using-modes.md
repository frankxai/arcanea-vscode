...
Modes in Arcanea are specialized personas that tailor the assistant's behavior to your current task. Each mode offers different capabilities, expertise, and access levels to help you accomplish specific goals.
...
<YouTubeEmbed
  ...
  caption="Explaining the different modes in Arcanea"
/>
...
4. **Accept suggestions:** Click on mode switch suggestions that Arcanea offers when appropriate
   
    <img src="/docs/img/modes/modes-2.png" alt="Accepting a mode switch suggestion from Arcanea" width="400" />
