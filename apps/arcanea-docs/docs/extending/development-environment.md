...
<!-- Please refer to the [DEVELOPMENT.md](https://github.com/Arcanea-Org/arcanea/blob/main/DEVELOPMENT.md) guide in the main repository for detailed instructions on setting up the development environment. -->
...
2. **Node.js** (version [v20.18.1](https://github.com/Arcanea-Org/arcanea/blob/main/.nvmrc) or higher recommended) and npm
...
For more details on E2E tests, see [e2e/VSCODE_INTEGRATION_TESTS.md](https://github.com/Arcanea-Org/arcanea/blob/main/e2e/VSCODE_INTEGRATION_TESTS.md).
