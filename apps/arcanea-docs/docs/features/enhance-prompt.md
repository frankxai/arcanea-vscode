...
*   **Better Instructions:**  Arcanea can add instructions to guide the AI towards a more helpful response (e.g., requesting specific formatting or a particular level of detail).
*   **Reduced Ambiguity:**  Enhance Prompt helps to eliminate ambiguity and ensure that Arcanea understands your intent.
*   **Consistency**: Arcanea will consistently format prompts the same way to the AI.
...
1.  **Type your initial prompt:**  Enter your request in the Arcanea chat input box as you normally would.  This can be a simple question, a complex task description, or anything in between.
...
3.  **Review the Enhanced Prompt:**  Arcanea will replace your original prompt with an enhanced version.  Review the enhanced prompt to make sure it accurately reflects your intent. You can further refine the enhanced prompt before sending.
4.  **Send the Enhanced Prompt:**  Press Enter or click the Send icon (<Codicon name="send" />) to send the enhanced prompt to Arcanea.
...
*   **Review Carefully:**  Always review the enhanced prompt before sending it.  Arcanea may make changes that don't align with your intentions.
...
By using the "Enhance Prompt" feature, you can improve the quality of your interactions with Arcanea and get more accurate and helpful responses.
