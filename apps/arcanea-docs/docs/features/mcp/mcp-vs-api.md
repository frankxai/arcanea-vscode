...
## Why Arcanea Uses MCP

Arcanea leverages MCP to provide:
...
MCP creates a universal connector between Arcanea and external services, with REST APIs often powering those services behind the scenes.
