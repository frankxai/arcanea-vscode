...
Arcanea implements a sophisticated tool system that allows AI models to interact with your development environment in a controlled and secure manner. This document explains how tools work, when they're called, and how they're managed.
...
### Read Tools
These tools help Arcanea understand your code and project:
...
### Edit Tools
These tools help Arcanea make changes to your code:
