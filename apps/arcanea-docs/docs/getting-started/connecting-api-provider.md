...
Arcanea requires an API key from an AI model provider to function. 

We recommend these options for accessing the powerful **Claude 4 Sonnet** model:

- **Arcanea API provider (Recommended):** Provides access to all of the models available through OpenRouter with competitive pricing and free credits to get started. [View pricing](https://arcanea.ai/pricing)
...
## Using the Arcanea Provider
By default when you install Arcanea the extension, you'll be prompted to sign in or create an account in the [Arcanea Provider](/providers/arcanea).

That will walk you through the account setup and _automatically_ configure Arcanea properly to get you started. If you'd rather use another provider, you'll need to manually get your API key as described below.
...
4. Copy your API key - you'll need this for Arcanea setup
...
### Configuring the Provider in Arcanea

Once you have your API key:

1. Open the Arcanea sidebar by clicking the Arcanea icon (<img src="/docs/img/arcanea-v1.svg" width="12" />) in the VS Code Side Bar
...
5. Click "Let's go!" to save your settings and start using Arcanea
