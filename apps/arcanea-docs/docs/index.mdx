...
Arcanea **accelerates** development with AI-driven code generation and task automation. This open source extension plugs directly into VS Code.
...
1. [Install Arcanea](/getting-started/installing)
2. [Set up Arcanea](/getting-started/setting-up)
3. [Try Your First Task](/getting-started/your-first-task)

## Features

<Image src="/docs/img/arcanea.gif" alt="GIF showing some of the capabilities of Arcanea" width="600" />

### Basics

Use [the chat interface](/basic-usage/the-chat-interface) to tell Arcanea what you need. It relies on coding‑optimized AI models to complete each request.
...
#### Multiple Modes
Arcanea adapts to your needs with specialized [modes](/basic-usage/using-modes):
...
#### Core Tools
Arcanea comes with powerful [tools](/features/tools/tool-use-overview) that can:
...
- **[Local Models](/advanced-usage/local-models):** Run Arcanea with local AI models for offline use or enhanced privacy

### Customizing Arcanea
Make Arcanea work your way with:
...
### Documentation
- [Using Arcanea](/basic-usage/the-chat-interface) - Learn the basics
...
- **YouTube:** <a href={YOUTUBE_URL} target="_blank">Check out our YouTube</a> to learn hands on skills when using Arcanea
...
Ready to get started? Click the **Next** button below to begin your journey with Arcanea!
