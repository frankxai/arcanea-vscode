...
# Using Fireworks AI With Arcanea
...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "Arcanea").
...
Arcanea supports the following Fireworks AI models:
