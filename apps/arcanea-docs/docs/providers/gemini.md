...
# Using Google Gemini With Arcanea

Arcanea supports Google's Gemini family of models through the Google AI Gemini API.
...
Arcanea supports the following Gemini models:
