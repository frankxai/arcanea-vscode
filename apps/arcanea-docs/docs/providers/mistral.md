...
# Using Mistral AI With Arcanea

Arcanea supports accessing models through the Mistral AI API, including both standard Mistral models and the code-specialized Codestral model.
...
Arcanea supports the following Mistral models:
...
The default model temperature in Arcanea is 0.0, so you should consider experimenting with [temperature adjustments](/features/model-temperature)!
