...
# Using OpenAI With Arcanea

Arcanea supports accessing models directly through the official OpenAI API.
...
3.  **Create a Key:** Click "Create new secret key". Give your key a descriptive name (e.g., "Arcanea").
4.  **Copy the Key:** **Important:** Copy the API key *immediately*. You will not be able to see it again. Store it securely.

## Supported Models

Arcanea supports a variety of OpenAI models, including:
