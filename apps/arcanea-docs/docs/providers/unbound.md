...
Unbound allows you configure a list of supported models in your application, and Arcanea will automatically fetch the list of available models from the Unbound API.
