...
# Using v0 With Arcanea

Arcanea supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with Arcanea through the familiar OpenAI API interface.

## Prerequisites

To use v0 with Arcanea, you'll need:
...
Setting up v0 in Arcanea is straightforward:

1. In Arcanea settings (click the <Codicon name="gear" /> icon):
...
<img src="/docs/img/providers/v0-setup.png" alt="v0 configuration in Arcanea settings" width="600" />
