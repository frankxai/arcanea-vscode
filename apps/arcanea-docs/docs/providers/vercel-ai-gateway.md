---
description: Configure the Vercel AI Gateway in Arcanea to robustly access 100+ language models from various providers through a centralized interface.
keywords:
    - arcanea
    - vercel ai gateway
    - ai provider
...
# Using Vercel AI Gateway With Arcanea
...
The Vercel AI Gateway supports a large and growing number of models. Arcanea automatically fetches the list of available models from the `https://ai-gateway.vercel.sh/v1/models` endpoint. Only language models are shown.
