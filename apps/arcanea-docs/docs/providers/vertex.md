...
# Using GCP Vertex AI With Arcanea

Arcanea supports accessing models through Google Cloud Platform's Vertex AI, a managed machine learning platform that provides access to various foundation models, including Anthropic's Claude family.
...
*   **Application Default Credentials (ADC):**  Arcanea uses Application Default Credentials to authenticate with Vertex AI. The easiest way to set this up is to:
...
Arcanea supports the following models through Vertex AI (based on source code):
