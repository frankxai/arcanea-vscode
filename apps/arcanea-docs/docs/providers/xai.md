...
3.  **Create a Key:** Click to create a new API key. Give your key a descriptive name (e.g., "Arcanea").
4.  **Copy the Key:** **Important:** Copy the API key *immediately*. You will not be able to see it again. Store it securely.

## Supported Models

Arcanea supports the following xAI Grok models:
