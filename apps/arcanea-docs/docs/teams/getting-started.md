...
# Get Started with Arcanea for Teams in 10 Minutes

Arcanea for Teams brings transparent AI coding to your entire engineering organization. No markup on AI costs, no vendor lock-in, complete usage visibility.
...
1. Visit [app.arcanea.com](https://app.arcanea.com)
...
2. Install Arcanea from [VS Code Marketplace](vscode:extension/arcanea.arcanea)
