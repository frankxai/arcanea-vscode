...
Arcanea for Teams uses a three-tier role system designed for clear responsibility separation and secure team management.
...
**Standard usage access** - Individual contributors who use Arcanea for development work.
