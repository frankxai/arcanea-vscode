...
const config: Config = {
    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          {
            to: '/features/mcp/using-mcp-in-arcanea',
            from: ['/mcp/using-mcp-in-arcanea'],
          },
          {
  ...
  themeConfig: {
    image: 'img/arcanea-v1.svg',
    navbar: {
      title: 'Arcanea',
      logo: {
        alt: 'Arcanea Logo',
        src: 'img/arcanea-v1.svg',
        srcDark: 'img/arcanea-v1-white.svg',
        href: '/',
        target: '_self'
      },
      items: [
