...
Arcanea 支持使用 [Ollama](https://ollama.com/) 和 [LM Studio](https://lmstudio.ai/) 在本地计算机上运行语言模型。这提供了以下优势：

*   **隐私性**：你的代码和数据永远不会离开你的计算机。
*   **离线访问**：即使没有互联网连接，你也可以使用 Arcanea。
...
*   **“由于目标计算机主动拒绝，无法建立连接”**：这通常意味着 Ollama 或 LM Studio 服务器未运行，或者 Arcanea 配置的端口/地址与服务器不一致。请仔细检查 Base URL 设置。
