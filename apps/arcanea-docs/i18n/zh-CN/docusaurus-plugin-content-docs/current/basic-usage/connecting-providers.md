...
**总结**：Arcanea，像任何代理 AI 编码工具一样，需要 AI 模型提供商才能运行。您可以使用我们的[内置提供商](/providers/arcanea)（最简单）或连接来自 **30 多个提供商**的您自己的 API 密钥。
...
- 您从市场安装的 VS Code 工具
- 处理 UI、文件操作和工作流管理
- [开源](https://github.com/Arcanea-Org/arcanea)
- 连接到任何 AI 提供商
...
- 无需 API 密钥管理
- 访问前沿编码模型
- [有竞争力的定价](https://arcanea.ai/pricing)
...
### 选项 1：内置提供商（推荐）
✅ **最快设置**
- 在 arcanea.ai 使用 Google 登录
- 包含免费积分
- 零 API 密钥管理
- 提供最新模型

→ [完整设置指南](/providers/arcanea)
