...
根据您暂存的 git 更改自动生成描述性提交消息。Arcanea 会分析您暂存的文件并创建遵循最佳实践的约定式提交消息。
...
2.  在 VS Code 源代码管理面板中，查找提交消息字段旁边的 `Arcanea` 徽标)
3.  单击徽标以生成提交消息
...
- [设置管理](/features/settings-management) - 管理您的所有 Arcanea 首选项
