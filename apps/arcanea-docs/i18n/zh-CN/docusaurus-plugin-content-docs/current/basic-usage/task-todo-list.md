...
<img src="/docs/img/task-todo-list/task-todo-list-1.png" alt="任务待办事项列表概述，显示 Arcanea 中的交互式清单" width="500" />
...
**手动触发**：
- 要求 Arcanea“使用 [update_todo_list 工具](/features/tools/update-todo-list)”
- 说“创建待办事项列表”

**底线**：Arcanea 决定列表中包含什么，但您可以在批准对话框中提供反馈。
...
**现在**：Arcanea 创建结构化清单，随着工作的进展自动更新。您清楚地知道自己所处的位置以及接下来要做什么。
...
**“可以创建自己的待办事项列表吗？”**
是的，只需要求 Arcanea 使用 update_todo_list 工具。但 Arcanea 仍控制内容和工作流。

**“简单的任务怎么办？”**
Arcanea 通常会跳过简单任务的待办事项列表。开销不值得。

**“为什么不能直接编辑列表？”**
设计选择。Arcanea 保持对任务管理的控制，以确保一致的进度跟踪。您提供输入，Arcanea 执行。
