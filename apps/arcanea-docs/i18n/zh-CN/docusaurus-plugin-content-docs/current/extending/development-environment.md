...
<!-- 请参考主仓库中的 [DEVELOPMENT.md](https://github.com/Arcanea-Org/arcanea/blob/main/DEVELOPMENT.md) 指南，获取详细的开发环境设置说明。 -->
...
1. **Git** - 用于版本控制
2. **Node.js**（建议使用 [v20.18.1](https://github.com/Arcanea-Org/arcanea/blob/main/.nvmrc) 或更高版本）和 npm
...
1. **Fork 并克隆仓库**：
    ...
    - **Fork 仓库**：
        - 访问 [Arcanea GitHub 仓库](https://github.com/Arcanea-Org/arcanea)
...
推荐的扩展完整列表在[这里](https://github.com/Arcanea-Org/arcanea/blob/main/.vscode/extensions.json)
...
2. 这将打开一个新的 VSCode 窗口，并加载 Arcanea
...
有关 E2E 测试的更多详细信息，请参阅 [e2e/VSCODE_INTEGRATION_TESTS.md](https://github.com/Arcanea-Org/arcanea/blob/main/e2e/VSCODE_INTEGRATION_TESTS.md)。
...
- 检查 VSCode 中的输出面板（View > Output）并从下拉菜单中选择 "Arcanea"
