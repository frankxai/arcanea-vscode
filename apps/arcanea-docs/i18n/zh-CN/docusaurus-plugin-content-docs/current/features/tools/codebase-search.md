...
- 当 Arcanea 需要在您的项目中查找与特定功能相关的代码时
- 当查找实现模式或相似的代码结构时
...
- 在实现新功能时，Arcanea 搜索“身份验证中间件”以了解现有模式，然后才编写新代码。
- 在调试问题时，Arcanea 搜索“API 调用中的错误处理”以查找代码库中相关的错误模式。
- 在重构代码时，Arcanea 搜索“数据库事务模式”以确保所有数据库操作的一致性。
- 在熟悉新代码库时，Arcanea 搜索“配置加载”以了解应用程序如何启动。
