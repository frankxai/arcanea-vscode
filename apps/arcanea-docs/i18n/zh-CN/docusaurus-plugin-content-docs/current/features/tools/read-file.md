...
`read_file`工具用于读取项目中的文件内容。它允许 Arcanea 理解代码、配置文件和文档，以提供更好的协助。
...
- 当 Arcanea 需要理解现有代码结构时
- 当 Arcanea 需要分析配置文件时
- 当 Arcanea 需要从文本文件中提取信息时
- 当 Arcanea 在建议更改前需要查看代码时
- 当需要在讨论中引用特定行号时
...
- 当要求解释或改进代码时，Arcanea 首先读取相关文件以理解当前实现
- 当排查配置问题时，Arcanea 读取配置文件以识别潜在问题
- 当处理文档时，Arcanea 读取现有文档以理解当前内容再建议改进
