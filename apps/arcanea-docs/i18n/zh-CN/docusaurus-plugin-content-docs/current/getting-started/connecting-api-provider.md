...
Arcanea 需要 AI 模型提供商的 API 密钥才能运行。

我们推荐以下选项来访问强大的 **Claude 4 Sonnet** 模型：

- **Arcanea API 提供商（推荐）：** 以有竞争力的价格提供对 OpenRouter 可用的所有模型的访问权限，并提供免费积分以供入门。 [查看定价](https://arcanea.ai/pricing)
...
## 使用 Arcanea 提供商
默认情况下，当您安装 Arcanea 扩展时，系统会提示您在 [Arcanea 提供商](/providers/arcanea)中登录或创建帐户。

这将引导您完成帐户设置并*自动*正确配置 Arcanea 以帮助您入门。如果您更喜欢使用其他提供商，则需要按照以下说明手动获取您的 API 密钥。
...
1. 点击VS Code侧边栏中的Arcanea图标(<img src="/docs/img/arcanea-v1.svg" width="12" />)打开Arcanea侧边栏
...
5. 点击"Let's go!"保存设置并开始使用Arcanea
