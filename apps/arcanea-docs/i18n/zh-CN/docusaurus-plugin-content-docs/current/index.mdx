...
Arcanea 通过 AI 驱动的代码生成和任务自动化**加速**开发。这个开源扩展直接集成到 VS Code 中。
...
1. [安装 Arcanea](/getting-started/installing)
2. [设置 Arcanea](/getting-started/setting-up)
3. [尝试你的首个任务](/getting-started/your-first-task)

## 功能

<Image src="/docs/img/arcanea.gif" alt="展示 Arcanea 部分功能的 GIF" width="600" />

### 基础功能

使用[聊天界面](/basic-usage/the-chat-interface)告诉 Arcanea 您需要什么。它依赖于针对编码优化的 AI 模型来完成每个请求。
...
#### 多种模式
Arcanea 通过专门的[模式](/basic-usage/using-modes)适应你的需求：
...
#### 核心工具
Arcanea 配备了强大的[工具](/features/tools/tool-use-overview)，可以：
...
- **[本地模型](/advanced-usage/local-models)：** 使用本地 AI 模型运行 Arcanea，以实现离线使用或增强隐私

### 自定义 Arcanea
通过以下方式让 Arcanea 按照你的方式工作：
...
### 文档
- [使用 Arcanea](/basic-usage/the-chat-interface) - 学习基础知识
...
- **YouTube：** <a href={YOUTUBE_URL} target="_blank">查看我们的 YouTube</a>以学习使用 Arcanea 的实践技能
...
准备好开始了吗？点击下方的**下一步**按钮，开启你的 Arcanea 之旅！
