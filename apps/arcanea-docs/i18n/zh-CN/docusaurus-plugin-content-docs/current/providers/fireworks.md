...
3. **创建密钥：** 点击 "Create API key" 并为您的密钥输入一个描述性名称（例如 "Arcanea"）。
...
1. **打开 Arcanea 设置：** 在 Arcanea 面板中点击齿轮图标 (<Codicon name="gear" />)。
