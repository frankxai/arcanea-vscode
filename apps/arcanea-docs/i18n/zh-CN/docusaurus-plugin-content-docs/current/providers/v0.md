...
Arcanea 支持 v0，Vercel 的 AI 模型提供商，它提供与 OpenAI 兼容的 API。这允许您通过熟悉的 OpenAI API 界面在 Arcanea 中使用 v0 的模型。

## 先决条件

要在 Arcanea 中使用 v0，您需要：
...
在 Arcanea 中设置 v0 非常简单：

1.  在 Arcanea 设置中（单击 <Codicon name="gear" /> 图标）：
...
<img src="/docs/img/providers/v0-setup.png" alt="Arcanea 设置中的 v0 配置" width="600" />
