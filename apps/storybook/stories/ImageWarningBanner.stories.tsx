// arcanea_change new file - Storybook stories for ImageWarningBanner component
...
export const ModelNoImageSupport: Story = {
	args: {
		messageKey: "arcanea:imageWarnings.modelNoImageSupport",
	},
}

export const MaxImagesReached: Story = {
	args: {
		messageKey: "arcanea:imageWarnings.maxImagesReached",
	},
}
