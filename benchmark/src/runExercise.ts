...
export async function run() {
	...
	const extension = vscode.extensions.getExtension<RooCodeAPI>("arcanea.Arcanea-Code")
	...
	/**
	 * Wait for the Arcanea to be ready to accept tasks.
	 */

	await waitUntilReady({ api })

	/**
	 * Configure Arcanea as needed.
	 *
