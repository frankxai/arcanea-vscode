...
This directory contains the JetBrains plugin implementation for Arcanea, including both the IntelliJ plugin (Kotlin) and the Extension Host (Node.js/TypeScript).
...
pnpm --filter @arcanea/jetbrains-host build
```
...
- `vscodePlugin`: Plugin name (default: arcanea)
