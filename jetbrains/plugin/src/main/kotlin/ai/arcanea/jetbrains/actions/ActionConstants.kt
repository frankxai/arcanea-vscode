...
object CommandIds {
    ...
    const val EXPLAIN = "arcanea.explainCode"
    /** Command ID for fixing code */
    const val FIX = "arcanea.fixCode"
    /** Command ID for improving code */
    const val IMPROVE = "arcanea.improveCode"
    /** Command ID for adding to context */
    const val ADD_TO_CONTEXT = "arcanea.addToContext"
    /** Command ID for creating a new task */
    const val NEW_TASK = "arcanea.newTask"
}
