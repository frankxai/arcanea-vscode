...
package ai.arcanea.jetbrains.actions
...
class PlusButtonClickAction : AnAction() {
    ...
    private val commandId: String = "arcanea.plusButtonClicked"
...
class PromptsButtonClickAction : AnAction() {
    ...
    private val commandId: String = "arcanea.promptsButtonClicked"
...
class MCPButtonClickAction : AnAction() {
    ...
    private val commandId: String = "arcanea.mcpButtonClicked"
...
class HistoryButtonClickAction : AnAction() {
    ...
    private val commandId: String = "arcanea.historyButtonClicked"
...
class ProfileButtonClickAction : AnAction() {
    ...
    private val commandId: String = "arcanea.profileButtonClicked"
    /**
...
class SettingsButtonClickAction : AnAction() {
    ...
    private val commandId: String = "arcanea.settingsButtonClicked"
...
class MarketplaceButtonClickAction : AnAction() {
    ...
    private val commandId: String = "arcanea.marketplaceButtonClicked"
 ...
 */
class OpenDevToolsAction(private val getWebViewInstance: () -> ai.arcanea.jetbrains.webview.WebViewInstance?) : AnAction("Open Developer Tools") {
