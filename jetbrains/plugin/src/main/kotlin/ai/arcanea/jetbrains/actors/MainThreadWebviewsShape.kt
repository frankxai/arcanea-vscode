...
package ai.arcanea.jetbrains.actors

import com.intellij.openapi.Disposable
import com.intellij.openapi.diagnostic.Logger
import com.intellij.openapi.project.Project
import com.intellij.openapi.project.ProjectManager
import ai.arcanea.jetbrains.events.EventBus
import ai.arcanea.jetbrains.events.ProjectEventBus
import ai.arcanea.jetbrains.events.WebviewHtmlUpdateData
import ai.arcanea.jetbrains.events.WebviewHtmlUpdateEvent
...
class MainThreadWebviews(val project: Project) : MainThreadWebviewsShape {
    ...
    override fun setHtml(handle: WebviewHandle, value: String) {
        ...
        try {
            // Replace vscode-file protocol format, using regex to match from vscode-file:/ to /arcanea/ part
            val modifiedHtml = value.replace(Regex("vscode-file:/.*?/arcanea/"), "/")
