...
import ai.arcanea.jetbrains.editor.EditorAndDocManager
import ai.arcanea.jetbrains.ipc.NodeSocket
import ai.arcanea.jetbrains.ipc.PersistentProtocol
import ai.arcanea.jetbrains.ipc.proxy.ResponsiveState
import ai.arcanea.jetbrains.util.PluginConstants
import ai.arcanea.jetbrains.util.PluginResourceUtil
import ai.arcanea.jetbrains.util.URI
    ...
    private fun createInitData(): Map<String, Any?> {
        ...
        return mapOf(
            ...
            "environment" to mapOf(
                ...
                "globalStorageHome" to uriFromPath(Paths.get(System.getProperty("user.home"),".arcanea", "globalStorage").toString()),
                "workspaceStorageHome" to uriFromPath(Paths.get(System.getProperty("user.home"),".arcanea", "workspaceStorage").toString()),
