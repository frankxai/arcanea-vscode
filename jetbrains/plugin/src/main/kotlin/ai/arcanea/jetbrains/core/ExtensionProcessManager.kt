...
import ai.arcanea.jetbrains.util.ProxyConfigUtil
import java.io.File
import java.util.concurrent.TimeUnit
import ai.arcanea.jetbrains.util.ExtensionUtils
import ai.arcanea.jetbrains.util.PluginConstants
import ai.arcanea.jetbrains.util.NotificationUtil
import ai.arcanea.jetbrains.util.NodeVersionUtil
import ai.arcanea.jetbrains.util.NodeVersion
import ai.arcanea.jetbrains.i18n.I18n
...
//                "--trace-uncaught",
    ...
    fun findExtensionEntryFile(): String? {
        ...
        // Normal mode
        val resourcesPath = ai.arcanea.jetbrains.util.PluginResourceUtil.getResourcePath(PLUGIN_ID, "$RUNTIME_DIR/$EXTENSION_ENTRY_FILE")
        if (resourcesPath != null) {
