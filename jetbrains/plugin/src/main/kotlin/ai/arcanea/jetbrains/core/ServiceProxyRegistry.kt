...
package ai.arcanea.jetbrains.core

import com.intellij.openapi.components.Service
import com.intellij.openapi.diagnostic.Logger
import ai.arcanea.jetbrains.actors.*
import ai.arcanea.jetbrains.ipc.proxy.createProxyIdentifier
import ai.arcanea.jetbrains.ipc.proxy.interfaces.*
...
//
    ...
    object ExtHostContext {
        ...
        val ExtHostCommands = createProxyIdentifier<ExtHostCommandsProxy>("ai.arcanea.jetbrains.ipc.proxy.interfaces.ExtHostCommandsProxy")
        val ExtHostConfiguration = createProxyIdentifier<ExtHostConfigurationProxy>("ai.arcanea.jetbrains.ipc.proxy.interfaces.ExtHostConfigurationProxy")
        ...
        val ExtHostDocumentsAndEditors = createProxyIdentifier<ExtHostDocumentsAndEditorsProxy>("ai.arcanea.jetbrains.ipc.proxy.interfaces.ExtHostDocumentsAndEditorsProxy")
        val ExtHostDocuments = createProxyIdentifier<ExtHostDocumentsProxy>("ai.arcanea.jetbrains.ipc.proxy.interfaces.ExtHostDocumentsProxy")
        ...
        val ExtHostEditors = createProxyIdentifier<ExtHostEditorsProxy>("ai.arcanea.jetbrains.ipc.proxy.interfaces.ExtHostEditorsProxy")
        ...
        val ExtHostFileSystemEventService = createProxyIdentifier<ExtHostFileSystemEventServiceProxy>("ai.arcanea.jetbrains.ipc.proxy.interfaces.ExtHostFileSystemEventServiceProxy")
        ...
        val ExtHostExtensionService = createProxyIdentifier<ExtHostExtensionServiceProxy>("ai.arcanea.jetbrains.ipc.proxy.interfaces.ExtHostExtensionServiceProxy")
        val ExtHostLogLevelServiceShape = createProxyIdentifier<Any>("ExtHostLogLevelServiceShape")
        val ExtHostTerminalService = createProxyIdentifier<ExtHostTerminalServiceProxy>("ai.arcanea.jetbrains.ipc.proxy.interfaces.ExtHostTerminalServiceProxy")
        val ExtHostTerminalShellIntegration = createProxyIdentifier<ExtHostTerminalShellIntegrationProxy>("ai.arcanea.jetbrains.ipc.proxy.interfaces.ExtHostTerminalShellIntegrationProxy")
        ...
        val ExtHostWorkspace = createProxyIdentifier<ExtHostWorkspaceProxy>("ai.arcanea.jetbrains.ipc.proxy.interfaces.ExtHostWorkspaceProxy")
        val ExtHostWindow = createProxyIdentifier<Any>("ExtHostWindow")
        val ExtHostWebviews = createProxyIdentifier<ExtHostWebviewsProxy>("ai.arcanea.jetbrains.ipc.proxy.interfaces.ExtHostWebviewsProxy")
        ...
        val ExtHostWebviewViews = createProxyIdentifier<ExtHostWebviewViewsProxy>("ai.arcanea.jetbrains.ipc.proxy.interfaces.ExtHostWebviewViewsProxy")
        val ExtHostEditorInsets = createProxyIdentifier<Any>("ExtHostEditorInsets")
        val ExtHostEditorTabs = createProxyIdentifier<ExtHostEditorTabsProxy>("ai.arcanea.jetbrains.ipc.proxy.interfaces.ExtHostEditorTabsProxy")
