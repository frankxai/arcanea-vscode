...
package ai.arcanea.jetbrains.ui
...
import ai.arcanea.jetbrains.actions.OpenDevToolsAction
import ai.arcanea.jetbrains.plugin.WecoderPlugin
import ai.arcanea.jetbrains.plugin.WecoderPluginService
import ai.arcanea.jetbrains.plugin.DEBUG_MODE
import ai.arcanea.jetbrains.webview.DragDropHandler
import ai.arcanea.jetbrains.webview.WebViewCreationCallback
import ai.arcanea.jetbrains.webview.WebViewInstance
    ...
    private class RooToolWindowContent(
        ...
        private fun createSystemInfoText(): String {
            ...
            return buildString {
                ...
                append("<p>Arcanea is initializing...")
                ...
                if (!jcefSupported) {
                    ...
                    append("<a href='https://arcanea.ai/docs/jetbrains-troubleshooting' target='_blank' style='color: #721c24; text-decoration: underline;'>See JetBrains docs for how to enable JCEF in your IDE</a>")
                    append("</div>")
                    append("<br>")
                }
        ...
        private val knownIssuesButton = JButton("Known Issues").apply {
            ...
            addActionListener {
                ...
                BrowserUtil.browse("https://arcanea.ai/docs")
            }
        }
