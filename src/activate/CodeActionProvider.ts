...
import { CodeActionName, CodeActionId } from "@arcanea/types"
...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Arcanea",
	FIX: "Fix with Arcanea",
	IMPROVE: "Improve with Arcanea",
	ADD_TO_CONTEXT: "Add to Arcanea",
	NEW_TASK: "New Arcanea Task",
} as const
