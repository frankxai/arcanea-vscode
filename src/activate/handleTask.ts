...
export const handleNewTask = async (
	// arcanea_change start: Add profile and mode switching support
	...
	// arcanea_change start: Handle profile and mode switching if provided
	...
	// arcanea_change end: Add profile and mode switching support
