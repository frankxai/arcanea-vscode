...
export function getVisibleProviderOrLog(outputChannel: vscode.OutputChannel): ClineProvider | undefined {
	...
	if (!visibleProvider) {
		outputChannel.appendLine("Cannot find any visible Arcanea instances.")
		return undefined
	}
...
export const openClineInNewTab = async ({ context, outputChannel }: Omit<RegisterCommandOptions, "provider">) => {
	...
	const newPanel = vscode.window.createWebviewPanel(ClineProvider.tabPanelId, "Arcanea", targetCol, {
		enableScripts: true,
