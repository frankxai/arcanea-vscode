...
export class LmStudioHandler extends BaseProvider implements SingleCompletionHandler {
	...
	override async *createMessage(
		...
		try {
			...
			throw new Error(
				"Please check the LM Studio developer logs to debug what went wrong. You may need to load the model with a larger context length to work with Arcanea's prompts.",
			)
		}
	}
