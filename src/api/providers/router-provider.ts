...
const TEMPERATURE_UNSUPPORTED_PREFIXES = ["openai/o3", "openai/gpt5", "gpt-5"] // arcanea_change
...
export abstract class RouterProvider extends BaseProvider {
	...
	protected supportsTemperature(modelId: string): boolean {
		return !TEMPERATURE_UNSUPPORTED_PREFIXES.some((prefix) => modelId.startsWith(prefix)) // arcanea_change
	}
}
