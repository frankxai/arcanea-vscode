...
Custom modes can be configured in two ways:
  ...
  2. Per-workspace via '.arcaneamodes' in the workspace root directory

When modes with the same slug exist in both files, the workspace-specific .arcaneamodes version takes precedence. This allows projects to override global modes or define project-specific modes.


If asked to create a project mode, create it in .arcaneamodes in the workspace root. If asked to create a global mode, use the global custom modes file.
