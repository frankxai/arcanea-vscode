...
export class RooProtectedController {
	...
	getProtectionMessage(): string {
		return "This is a Arcanea configuration file and requires approval for modifications"
	}
	...
	getInstructions(): string {
		...
		return `# Protected Files\n\n(The following Arcanea configuration file patterns are write-protected and always require approval for modifications, regardless of autoapproval settings. When using list_files, you'll notice a ${SHIELD_SYMBOL} next to files that are write-protected.)\n\nProtected patterns: ${patterns}`
	}
