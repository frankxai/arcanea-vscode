...
vi.mock("fs/promises")
vi.mock("../roo-config", () => ({
	getGlobalRooDirectory: vi.fn(() => "/mock/global/.arcanea"),
	getProjectRooDirectoryForCwd: vi.fn(() => "/mock/project/.arcanea"),
}))
...
\`\`\``
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".arcanea", "commands", "setup.md"),
				description: "Sets up the development environment",
...
Global setup instructions.`
			...
			expect(result).toEqual({
				...
				source: "global",
				filePath: expect.stringContaining(path.join(".arcanea", "commands", "setup.md")),
				description: "Global setup command",
				argumentHint: undefined,
			})
		})
...
Create a new release.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".arcanea", "commands", "release.md"),
				description: "Create a new release of the Roo Code extension",
...
Deploy the application.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".arcanea", "commands", "deploy.md"),
				description: "Deploy application to environment",
