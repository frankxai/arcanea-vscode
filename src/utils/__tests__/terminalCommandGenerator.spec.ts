...
vi.mock("../../i18n", () => ({
	t: vi.fn((key: string, params?: any) => {
		const translations: Record<string, string> = {
			"arcanea:terminalCommandGenerator.inputPrompt": "Arcanea: Describe the command you want to generate",
			"arcanea:terminalCommandGenerator.inputPlaceholder":
				"e.g., kill the process running on port 3001, find large files, etc",
			"arcanea:terminalCommandGenerator.noActiveTerminal":
				"No active terminal found. Please open a terminal first.",
			"arcanea:terminalCommandGenerator.generatingProgress": "Generating terminal command...",
			"arcanea:terminalCommandGenerator.commandGenerated": `Generated command: ${params?.command || ""}`,
			"arcanea:terminalCommandGenerator.generationFailed": `Failed to generate command: ${params?.error || ""}`,
			"arcanea:terminalCommandGenerator.warningDialog.title": "Always Verify AI-Generated Commands",
			"arcanea:terminalCommandGenerator.warningDialog.message":
			...
			"arcanea:terminalCommandGenerator.warningDialog.okButton": "OK, I Understand",
			"arcanea:terminalCommandGenerator.warningDialog.cancelButton": "Cancel",
		}
...
describe("generateTerminalCommand", () => {
	...
	it("should generate and place terminal command without executing", async () => {
		...
		expect(vscode.window.showInputBox).toHaveBeenCalledWith({
			prompt: "Arcanea: Describe the command you want to generate",
