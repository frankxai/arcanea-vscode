...
import { ModeConfig } from "@arcanea/types"
import { SelectDropdown, DropdownOptionType } from "@/components/ui"
import { useAppTranslation } from "@/i18n/TranslationContext"
import { vscode } from "@/utils/vscode"
import { cn } from "@/lib/utils"

interface ArcaneaModeSelectorProps {
	value: Mode
...
export const ArcaneaModeSelector = ({
	value,
	onChange,
	modeShortcutText,
	customModes,
		...
		<SelectDropdown
			...
			options={[
				...
				...allModes.map((mode) => ({
					...
					description: mode.description, // arcanea_change
...
export default ArcaneaModeSelector
