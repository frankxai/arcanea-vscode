...
import { OPENROUTER_DEFAULT_PROVIDER_NAME, TelemetryEventName } from "@arcanea/types"
...
export const ArcaneacodeNotifications: React.FC = () => {
	...
	useEffect(() => {
		const handleMessage = (event: MessageEvent) => {
			...
			if (message.type === "arcaneaNotificationsResponse") {
	...
	useEffect(() => {
		vscode.postMessage({ type: "fetchArcaneacodeNotifications" })
	}, [])
	...
	return (
		<div className="arcanea-notifications flex flex-col mb-4">
