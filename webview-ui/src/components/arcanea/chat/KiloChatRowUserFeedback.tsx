...
interface ArcaneaChatRowUserFeedbackProps {
	message: ClineMessage
	isStreaming: boolean
	onChatReset?: () => void
}

export const ArcaneaChatRowUserFeedback = ({ message, isStreaming, onChatReset }: ArcaneaChatRowUserFeedbackProps) => {
