...
const RulesWorkflowsSection: React.FC<RulesWorkflowsSectionProps> = ({
	...
	const globalSectionKey =
		type === "rule" ? "arcanea:rules.sections.globalRules" : "arcanea:rules.sections.globalWorkflows"
	const workspaceSectionKey =
		type === "rule" ? "arcanea:rules.sections.workspaceRules" : "arcanea:rules.sections.workspaceWorkflows"
