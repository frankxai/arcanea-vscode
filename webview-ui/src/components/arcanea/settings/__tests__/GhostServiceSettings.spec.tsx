...
describe("GhostServiceSettingsView", () => {
	...
	it("renders basic trigger settings", () => {
		...
		expect(screen.getByText(/arcanea:ghost.settings.triggers/)).toBeInTheDocument()
		expect(screen.getByText(/arcanea:ghost.settings.enableAutoTrigger.label/)).toBeInTheDocument()
	})
	...
	it("shows advanced settings collapsed by default", () => {
		...
		expect(screen.getByText(/arcanea:ghost.settings.provider/)).toBeInTheDocument()
	})
	...
	it("toggles auto trigger checkbox correctly", () => {
		...
		const checkbox = screen
			.getByText(/arcanea:ghost.settings.enableAutoTrigger.label/)
			.closest("label")
	...
	it("toggles quick inline task keybinding checkbox correctly", () => {
		...
		const checkbox = screen
			.getByText(/arcanea:ghost.settings.enableQuickInlineTaskKeybinding.label/)
			.closest("label")
			?.querySelector("input[type='checkbox']")
	...
	it("toggles smart inline task keybinding checkbox correctly", () => {
		...
		const checkbox = screen
			.getByText(/arcanea:ghost.settings.enableSmartInlineTaskKeybinding.label/)
			.closest("label")
			?.querySelector("input[type='checkbox']")
	...
	it("toggles custom provider checkbox correctly", () => {
		...
		const checkbox = screen
			.getByText(/arcanea:ghost.settings.enableCustomProvider.label/)
			.closest("label")
			?.querySelector("input[type='checkbox']")
	...
	it("shows API config selector when custom provider is enabled", () => {
		...
		expect(screen.getByText(/arcanea:ghost.settings.apiConfigId.label/)).toBeInTheDocument()
	...
	it("shows auto-trigger delay slider when auto-trigger is enabled", () => {
		...
		expect(screen.getByText(/arcanea:ghost.settings.autoTriggerDelay.label/)).toBeInTheDocument()
	...
	it("hides auto-trigger delay slider when auto-trigger is disabled", () => {
		...
		expect(screen.queryByText(/arcanea:ghost.settings.autoTriggerDelay.label/)).not.toBeInTheDocument()
