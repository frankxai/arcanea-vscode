...
import { ArcaneaContextWindowProgressTokensUsed } from "../arcanea/chat/ArcaneaContextWindowProgressTokensUsed"
					...
					<div className="flex-1 relative">
						...
						<div className="flex items-center h-1 rounded-[2px] overflow-hidden w-full bg-[color-mix(in_srgb,var(--vscode-foreground)_20%,transparent)]">
							...
							<div
								...
								<ArcaneaContextWindowProgressTokensUsed currentPercent={currentPercent} />
							</div>
