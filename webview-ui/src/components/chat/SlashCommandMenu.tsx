...
const SlashCommandMenu: React.FC<SlashCommandMenuProps> = ({
	...
	const { localWorkflows, globalWorkflows } = useExtensionState() // arcanea_change
	...
	const filteredCommands = getMatchingSlashCommands(query, customModes, localWorkflows, globalWorkflows) // arcanea_change
