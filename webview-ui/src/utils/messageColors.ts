...
export const TASK_TIMELINE_MESSAGE_TYPES: Record<string, TaskTimelineMessageTypeConfig> = {
	...
	"ask:tool": {
		...
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.tool",
	},
	"ask:completion_result": {
		color: taskTimelineColorPalette.SUCCESS,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.completion_result",
	},
	"ask:browser_action_launch": {
		color: taskTimelineColorPalette.SYSTEM_GENERAL_TOOL,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.browser_action_launch",
	},
	"ask:use_mcp_server": {
		color: taskTimelineColorPalette.SYSTEM_GENERAL_TOOL,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.use_mcp_server",
	},
	"ask:command": {
		color: taskTimelineColorPalette.SYSTEM_GENERAL_TOOL,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.command",
	},
	"ask:followup": {
		color: taskTimelineColorPalette.ASSISTANT_QUESTION,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.followup",
	},

	// Say types that should be shown (everything except the filtered ones)
	"say:text": {
		color: taskTimelineColorPalette.ASSISTANT_MUTTERING,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.text",
	},
	"say:reasoning": {
		color: taskTimelineColorPalette.ASSISTANT_MUTTERING,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.reasoning",
	},
	"say:mcp_server_response": {
		color: taskTimelineColorPalette.SYSTEM_GENERAL_TOOL,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.mcp_server_response",
	},
	"say:command_output": {
		color: taskTimelineColorPalette.SYSTEM_GENERAL_TOOL,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.command_output",
	},
	"say:browser_action": {
		color: taskTimelineColorPalette.SYSTEM_GENERAL_TOOL,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.browser_action",
	},
	"say:browser_action_result": {
		color: taskTimelineColorPalette.SYSTEM_GENERAL_TOOL,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.browser_action_result",
	},
	...
	"say:error": {
		...
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.error",
	},
	"say:checkpoint_saved": {
		color: taskTimelineColorPalette.SUCCESS,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.checkpoint_saved",
	},
	"say:condense_context": {
		color: taskTimelineColorPalette.ASSISTANT_MUTTERING,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.condense_context",
	},
	"say:user_feedback": {
		color: taskTimelineColorPalette.USER_INTERACTION,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.user",
	},
	...
	"ask:condense": {
		color: taskTimelineColorPalette.ASSISTANT_MUTTERING,
		translationKey: "arcanea:taskTimeline.tooltip.messageTypes.condense",
	},
}
...
export function getMessageTypeDescription(message: ClineMessage | ClineMessage[], t: any): string {
	...
	if (!singleMessage) {
		return t("arcanea:taskTimeline.tooltip.messageTypes.unknown")
	}

	const messageKey = getTaskTimelineMessageTypeKey(singleMessage)
	const config = TASK_TIMELINE_MESSAGE_TYPES[messageKey]
	const translationKey = config ? config.translationKey : "arcanea:taskTimeline.tooltip.messageTypes.unknown"
